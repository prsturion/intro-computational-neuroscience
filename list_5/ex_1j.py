...
b = 0.8
phi = 0.08
I_const = 1.5  # after the impulse we keep I(t)=0
...
plt.xlabel("Tempo (t)")
plt.ylabel("v")
plt.title(f"FitzHugh–Nagumo (I={I_const}): v × t para diferentes v(0)")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig(f"intro-computational-neuroscience/list_5/figures/ex_1j_I{I_const}_1.png", dpi=300, bbox_inches="tight")  # save instead of show
...
plt.xlabel("Tempo (t)")
plt.ylabel("w")
plt.title(f"FitzHugh–Nagumo (I={I_const}): w × t para diferentes v(0)")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig(f"intro-computational-neuroscience/list_5/figures/ex_1j_I{I_const}_2.png", dpi=300, bbox_inches="tight")  # save instead of show
...
plt.xlabel("v (rápida)")
plt.ylabel("w (lenta)")
plt.title(f"Plano de fase w × v com nulclinas e trajetórias (I={I_const})")
plt.grid(True, alpha=0.3)
plt.legend(loc="best")
plt.tight_layout()
plt.savefig(f"intro-computational-neuroscience/list_5/figures/ex_1j_I{I_const}_3.png", dpi=300, bbox_inches="tight")  # save instead of show
