...
gc_new_value = 100
PARAMS["gc"] = gc_new_value * 1e-9 # nS
PARAMS["k"] = PARAMS["k"] * 2
...
plt.suptitle(f"$G_c = {gc_new_value}$ nS; $k$ dobrado")
...
plt.tight_layout()
plt.savefig(f"intro-computational-neuroscience/list_4/figures/ex_4_gc{gc_new_value}.png", dpi=150)
